...
* It's currently under discussion, with the intention of implementing a Lisp dialect for it. The previous plans of using WebAssembly have been scrapped because it's too immature. Some links regarding past discussions:
